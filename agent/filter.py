            ...
            messages=[
                {
                    ...
                    - Target roles: Vidyuth is looking for full-time permanent roles or internships only, not research fellowships or contractor positions. 
                    AI/ML Engineer, Software Engineer, Product roles, at AI startups. If not, moderately relevant roles are fine too.
                    - Open to: all roles in USA. Vidyuth is open to relocation within the USA
                    - Work authorization: Vidyuth has work authorization as he is a permanent resident of the USA and he does NOT require any visa sponsorship.
                    ...
                    - Very very curious and eager to learn everything deeply. Constant learner, loves new things. Asks lots of questions. Passionate.
                    - Constantly thinks of ideas, being a two-time founder. Always thinking how to improve processes/operations,
                    or just ideas in general for products/solutions/features.
                    - Approachable and loves to work with people, able to explain/present very very well due to speech & debate nationalist in highschool 
                    and many startup pitches/competitions – so he has soft skills and presentation skills to both technical and non-technical audiences
                    ...
                    "matching_skills": list containing all the tech skills that match with Vidyuth's background like [Python, React, etc]
                    "reason": “2 sentence explanation that does not include work authorization
                    in US as reason, because Vidyuth is authorized in US."
                    }
